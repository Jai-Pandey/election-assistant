...
const CURRENT_FACTS = {
  ...
  in: [
    ...
    { keywords: ['cji','supreme court chief'], answer: 'The **Chief Justice of India (CJI)** is appointed by the President on the recommendation of the outgoing CJI. The CJI heads the Supreme Court and plays a key role in judicial appointments through the collegium system.' },
